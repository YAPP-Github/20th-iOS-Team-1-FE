...
struct AccountInfoDTO: Codable {
    ...
    internal func toDomain() -> AccountInfo {
        let accountInfo = AccountInfo(nickName: nickname, address: address, age: age, sex: sex, Introduction: selfIntroduction, categories: interestCategories, profileImageURL: imageURL)
