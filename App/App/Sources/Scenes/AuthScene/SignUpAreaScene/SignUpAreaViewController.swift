...
final class SignUpAreaViewController: BaseViewController {
    ...
    private let bigCityLabel: UILabel = {
        let label = UILabel()
        label.text = "시/도"
    ...
    private let bigCityPickerView: UIPickerView = {
    ...
    private let bigCityContourView = ContourView()
    
    private let smallCityLabel: UILabel = {
        let label = UILabel()
        label.text = "시/군/구"
        label.font = UIFont.systemFont(ofSize: 14)
    ...
    private let smallCityPickerView: UIPickerView = {
        let pickerView = UIPickerView()
    ...
    private let smallCityContourView = ContourView()
    
    private let nextButtonContourView = ContourView()
    ...
    private func configureLayout() {
        ...
        NSLayoutConstraint.useAndActivateConstraints([
            ...
            nextButtonContourView.bottomAnchor.constraint(equalTo: nextButton.topAnchor, constant: -4),
            ...
            bigCityLabel.topAnchor.constraint(equalTo: guidanceLabel.bottomAnchor, constant: viewHeight * 0.1),
